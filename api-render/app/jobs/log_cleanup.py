...
async def cleanup_old_logs(
    ...
    try:
        ...
        while total_deleted < total_to_delete:
            ...
            logger.info(f"Deleted batch: {batch_deleted} entries (total: {total_deleted}/{total_to_delete})")
...
def cleanup_local_log_files(
    ...
    Returns:
        Dict with cleanup statistics
    """
    logger.info(f"Starting local log file cleanup - dir: {log_dir}, retention: {retention_days} days")
