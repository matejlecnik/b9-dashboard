...
export const queryKeys = {
  ...
  instagram: {
    ...
    viralContent: (filters?: unknown) => [...queryKeys.instagram.all(), 'viral', filters] as const,
    viralReels: (filters?: unknown) => [...queryKeys.instagram.all(), 'viral-reels', filters] as const,
    viralReelsStats: (filters?: unknown) => [...queryKeys.instagram.all(), 'viral-stats', filters] as const,
