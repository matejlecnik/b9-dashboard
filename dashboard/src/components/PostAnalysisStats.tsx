  ...
  return (
    <div className="flex gap-2 mb-3">
      ...
      <div className="flex-1 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg p-2.5 shadow-sm hover:shadow-md transition-shadow">
        <h3 className="text-xs font-medium text-gray-600 mb-1">Total Posts</h3>
      ...
      <div className="flex-1 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg p-2.5 shadow-sm hover:shadow-md transition-shadow">
        <h3 className="text-xs font-medium text-gray-600 mb-1">Best Subreddit</h3>
      ...
      <div className="flex-1 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg p-2.5 shadow-sm hover:shadow-md transition-shadow">
        <h3 className="text-xs font-medium text-gray-600 mb-1">Most Comments</h3>
        <p className="text-sm font-bold text-gray-900 truncate">
      ...
      <div className="flex-1 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg p-2.5 shadow-sm hover:shadow-md transition-shadow">
        <h3 className="text-xs font-medium text-gray-600 mb-1">Best Time</h3>
        <p className="text-lg font-bold text-gray-900">
