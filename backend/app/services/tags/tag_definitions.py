...
TAG_REGISTRY = {
    ...
    "ass": ["ass:small", "ass:bubble", "ass:big", "ass:jiggly"],
    "breasts": [
        "breasts:small",
        "breasts:medium",
        "breasts:large",
    ...
    "age": ["age:college", "age:adult", "age:milf", "age:mature", "age:gilf"],
    "ethnicity": [
        "ethnicity:asian",
        "ethnicity:latina",
        "ethnicity:ebony",
    ...
    "hair": ["hair:blonde", "hair:redhead", "hair:brunette", "hair:colored"],
    "special": [
        "special:hairy",
        "special:flexible",
        "special:tall",
    ...
    "content": ["content:oc", "content:professional"],
}
...
def validate_tags(tags: List[str]) -> Dict[str, Any]:
    ...
    return {"valid": len(errors) == 0, "errors": errors, "tag_count": len(tags)}
