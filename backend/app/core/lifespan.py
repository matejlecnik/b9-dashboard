    ...
    async def lifespan(app: FastAPI):
        ...
        try:
            ...
            tag_categorization_service_ref["instance"] = TagCategorizationService(
                supabase_ref["instance"], openai_key
            )
            ...
            logger.info(
                "📝 Scraper auto-start disabled - use /api/scraper/start endpoint to control"
            )
        ...
        try:
            ...
            logger.info("API shutdown complete", duration_ms=int(cleanup_time * 1000))
